          ...
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                children: [
                  InterFontTextWidget("Total Amount"),
                  InterFontTextWidget("15000 ks",color: Colors.red)
                ],
              ),
              CircleCutButtonWidget(
                ...
                buttonName: "Cancel Booking", inputColor: Colors.red,
              ),
            ],),
            SizedBox(
              height: X_HEIGHT,
...
class MovieTitleSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        InterFontTextWidget(CurrentAppState.receipt.movieName ?? ""),
        SizedBox(
          width: CHECKOUT_PAGE_MOVIE_PLACE_SECTION_WIDTH,
        ),
